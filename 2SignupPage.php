...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo"<Script> window.location. href = '2SignupPage.php';</script>";	
    ...
    if ($email && $password){
        ...
        if($check_email_row>0){
            ...
            $query=mysqli_query($connections, "INSERT INTO user (firstname,middlename,lastname,email,password,cpassword,account_type) 
    values ('$firstname','$middlename','$lastname','$email','$password','$cpassword','2')");
            }
        }
    }    
}
